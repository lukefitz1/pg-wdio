// add login from product page test
describe("Sign in to customer account", function () {
    ...
    describe("should open customer account login page", function() {
        ...
        it("should logout of customer account", function() {
            browser.url('/customer/account/logout');
        });
    });

    describe("should open login modal on homepage", function() {
        it("should login to PG customer account successfully from login modal on homepage", function () {
            browser.url("/");
            ...
            //header.loginModal.waitForVisible();
            browser.waitForVisible('#login-modal', 8000, true);
